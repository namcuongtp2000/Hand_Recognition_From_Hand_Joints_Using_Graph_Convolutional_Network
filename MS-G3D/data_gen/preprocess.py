...
if __name__ == '__main__':
    data = np.load('D:\\NGHIEN-CUU-COMVIS\\Coding\\MS-G3D\\data\\IPN\\IPN_val\\val_data.npy')
    pre_normalization(data)
    np.save('D:\\NGHIEN-CUU-COMVIS\\Coding\\MS-G3D\\data\\IPN\\IPN_val\\data_val_pre.npy', data)
