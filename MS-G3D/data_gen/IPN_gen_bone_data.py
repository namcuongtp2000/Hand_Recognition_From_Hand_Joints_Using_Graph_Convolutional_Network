...
bone_pairs = {
    ...
    'kinetics': ( #IPN
        (0, 0), (1, 0), (2, 1), (3, 2), (4, 3), (5, 0), (6, 5), (7, 6), (8, 7), (9, 5), (10, 9), (11, 10), (12, 11),
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Bone data generation for NTU60/IPN/Kinetics')
    parser.add_argument('--dataset', choices=['ntu', 'IPN', 'kinetics'], required=True)
    ...
    for benchmark in benchmarks[args.dataset]:
        for part in parts:
            ...
            try:
                data = np.load('D:\\TAI-LIEU-HOC-TAP\\Coding\\MS-G3D\\data\\{}\\{}_data_joint.npy'.format(benchmark, part), mmap_mode='r')
                N, C, T, V, M = data.shape
                fp_sp = open_memmap(
                    'D:\\TAI-LIEU-HOC-TAP\\Coding\\MS-G3D\\data\\{}\\{}_data_bone.npy'.format(benchmark, part),
                    dtype='float32',
                    mode='w+',
                    shape=(N, 3, T, V, M))
